...
def _usage(raw: Any) -> Usage:
    ...
    # ``cache_creation`` breaks the write down by entry lifetime. The one-hour tier is
    # billed at 2x input against 1.25x for the five-minute default, so the split has to
    # travel with the count or every write is priced at the cheaper rate.
