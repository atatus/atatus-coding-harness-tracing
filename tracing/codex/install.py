...
def install(with_skills: bool = False) -> None:
    ...
    codex_env_file = codex_home / ENV_FILE_NAME

    # Fail before touching anything if the user's config.toml can't be parsed —
...
def uninstall() -> None:
    ...
    # Same guard as install(): step 2 rewrites this file.
    _toml_load_strict(codex_config_file)
