...
class Usage:
    ...
    # Subset of cache_write_tokens written with a 1-hour TTL, which Anthropic bills at
    # 2x input against 1.25x for the 5-minute default. Dropping it under-prices the turn.
    ...
    def prompt_tokens(self) -> int:
        """Total input as the OpenInference consumer reads it: base plus both caches."""
