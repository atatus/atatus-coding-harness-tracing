...
HARNESSES: dict[str, HarnessMetadata] = {
    "claude-code": {
        ...
        "scope_name": "atatus-claude-tracing",
    ...
    "codex": {
        "service_name": "codex",
        "scope_name": "atatus-codex-tracing",
    ...
    "cursor": {
        "service_name": "cursor",
        "scope_name": "atatus-cursor-tracing",
    ...
    "copilot": {
        ...
        "scope_name": "atatus-copilot-tracing",
    ...
    "gemini": {
        "service_name": "gemini",
        "scope_name": "atatus-gemini-tracing",
